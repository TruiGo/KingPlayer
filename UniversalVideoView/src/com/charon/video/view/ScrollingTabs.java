...
public class ScrollingTabs extends HorizontalScrollView implements
    ...
    /**
     * True if you want to make make all the tabs equals the width when the
     * total width is less than the window width
     */
        ...
        if (mViewPager != null && mTabAdapter != null) {
            ...
            if (mEqualWidth) {
                ...
                if (totalWidth < mWindowWidth) {
                    ...
                    if (isUseSeperator) {
                        tabWidth = (mWindowWidth - (count - 1)
                                * mTabAdapter.getSeparator().getWidth())
                                / count;
                    } else {
            ...
            for (int i = 0; i < mViewPager.getAdapter().getCount(); i++) {
                ...
                if (tabWidth != 0) {
                    ...
                    mContainer.addView(tab, new LinearLayout.LayoutParams(0,
    ...
    /**
     * Set the tab width be all equals when all the tab width is less than the
     * window width<br>
     * <font color=red>Note：</font>This must be used before setTabAdapter and
     * setViewPager
     * 
     * @param flag
     */
