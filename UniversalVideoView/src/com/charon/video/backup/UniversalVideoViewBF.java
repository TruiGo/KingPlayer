...
import com.charon.video.backup.UniversalVideoViewBF.OnStateChangeListener.State;
 ...
 * @author Charon Chui
 */
public class UniversalVideoViewBF extends SurfaceView implements
    ...
    public UniversalVideoViewBF(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initVideoView(context);
    }

    public UniversalVideoViewBF(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVideoView(context);
    }

    public UniversalVideoViewBF(Context context) {
        super(context);
        initVideoView(context);
    }
